...
| `书籍/` | 原始 PDF 或教材资料 | 只读 |
| `ocr/` | OCR 底稿 | 只读为主 |
| `../../../00-Inbox/Clippings/` | 外部剪藏资料 | 可读取、可整理 |
...
| 层级 | 当前目录 | 说明 |
|---|---|---|
| 原始资料层 | `书籍/`、`ocr/`、`../../../00-Inbox/Clippings/` | 教材、OCR、外部文章、视频摘录；作为来源，不随意改写 |
...
- [[80-Archive/ResearchVault/obsidian/concepts/波函数]] 不只是一次解释，而是长期维护的概念页。
...
| 教材 PDF | `书籍/` | 作为最终校对来源 |
| OCR 文本 | `ocr/` | 作为章节整理底稿 |
| 网页剪藏 | `../../../00-Inbox/Clippings/` | 先做来源摘要，再决定是否入 wiki |
...
- 将网页保存为 Markdown。
- 将外部资料统一放入 `../../../00-Inbox/Clippings/` 或专门的来源目录。
- 让 Codex 后续把剪藏内容整理进正式 wiki。

建议规则：

- 外部剪藏先放 `../../../00-Inbox/Clippings/`。
- 不要直接把剪藏当作最终笔记。
...
- [[80-Archive/ResearchVault/obsidian/concepts/波函数]]
- [[Born 概率诠释]]
- [[Schrodinger 方程]]
- [[定态与非定态]]
- [[力学量算符]]
