...
- GDS：`disclination_a559_r0p2_n3p4.gds`
- PNG 预览：`disclination_a559_r0p2_n3p4_preview.png`
- 参数 JSON：`disclination_a559_r0p2_n3p4_params.json`
...
- 原始孔阵列外包络直径：`12.438618190694863` um
- 当前缩放倍数：`1.0`
- 当前孔阵列外包络直径：`12.438618190694863` um
...
- 最小孔边到孔边距离：`-0.11727188147820222` um
- 超出 substrate 的孔数量：`0`
- 超出 PML 的孔数量：`0`
