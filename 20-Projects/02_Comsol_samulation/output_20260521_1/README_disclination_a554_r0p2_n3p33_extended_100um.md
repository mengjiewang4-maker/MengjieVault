...
- GDS：`disclination_a554_r0p2_n3p33_extended_100um.gds`
- PNG 预览：`disclination_a554_r0p2_n3p33_extended_100um_preview.png`
- 参数 JSON：`disclination_a554_r0p2_n3p33_extended_100um_params.json`
- 本说明：`README_disclination_a554_r0p2_n3p33_extended_100um.md`
...
- 原始孔阵列外包络直径：`99.28423108447475` um
- 当前缩放倍数：`1.0`
- 当前孔阵列外包络直径：`99.28423108447475` um
- 扩展阵列 grid size：`117`
- 扩展阵列说明：`保持 a=0.554 um、r=0.11080000000000001 um 不变，按原始 5 扇区 disclination 规律扩展为 5 x 117 x 117 个圆孔。`
...
- 最小孔边到孔边距离：`-0.11622293799450821` um
- 超出 substrate 的孔数量：`64255`
- 超出 PML 的孔数量：`58970`
