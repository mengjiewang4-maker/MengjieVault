...
- GDS：`disclination_a554_r0p2_n3p33.gds`
- PNG 预览：`disclination_a554_r0p2_n3p33_preview.png`
- 参数 JSON：`disclination_a554_r0p2_n3p33_params.json`
...
- 原始孔阵列外包络直径：`12.327360425125143` um
- 当前缩放倍数：`1.0`
- 当前孔阵列外包络直径：`12.327360425125143` um
...
- 最小孔边到孔边距离：`-0.1162229379944975` um
- 超出 substrate 的孔数量：`0`
- 超出 PML 的孔数量：`0`
