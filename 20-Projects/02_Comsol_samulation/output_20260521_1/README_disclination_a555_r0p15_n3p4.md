...
- GDS：`disclination_a555_r0p15_n3p4.gds`
- PNG 预览：`disclination_a555_r0p15_n3p4_preview.png`
- 参数 JSON：`disclination_a555_r0p15_n3p4_params.json`
...
- 原始孔阵列外包络直径：`12.294111978239085` um
- 当前缩放倍数：`1.0`
- 当前孔阵列外包络直径：`12.294111978239085` um
...
- 最小孔径：`0.1665` um
- 最小孔边到孔边距离：`-0.06093272669123871` um
- 超出 substrate 的孔数量：`0`
- 超出 PML 的孔数量：`0`
