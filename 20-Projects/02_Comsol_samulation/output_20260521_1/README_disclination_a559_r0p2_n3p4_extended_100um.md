...
- PNG 预览：`disclination_a559_r0p2_n3p4_extended_100um_preview.png`
- 参数 JSON：`disclination_a559_r0p2_n3p4_extended_100um_params.json`
- 本说明：`README_disclination_a559_r0p2_n3p4_extended_100um.md`
...
- 原始孔阵列外包络直径：`100.18029815202416` um
- 当前缩放倍数：`1.0`
- 当前孔阵列外包络直径：`100.18029815202416` um
- 扩展阵列 grid size：`117`
- 扩展阵列说明：`保持 a=0.559 um、r=0.11180000000000001 um 不变，按原始 5 扇区 disclination 规律扩展为 5 x 117 x 117 个圆孔。`
...
- 最小孔径：`0.22360000000000002` um
- 最小孔边到孔边距离：`-0.11727188147821009` um
